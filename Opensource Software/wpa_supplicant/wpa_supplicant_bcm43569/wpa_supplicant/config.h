...
//dugang increase this value to avoid BSS entries disappearing if they are not visible in every scan
#define DEFAULT_BSS_EXPIRATION_SCAN_COUNT 4 //2
...
#define CFG_CHANGED_P2P_OPER_FREQ BIT(17)
#endif
#ifdef CONFIG_SUPPORT_SET_GO_INTENT
#define CFG_CHANGED_P2P_GO_INTENT BIT(18)
#endif
/**
