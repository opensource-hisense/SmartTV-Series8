...
struct p2p_peer_info {
	...
	int include_wfd_assoc_bssid;
	u8 wfd_assoc_bssid[ETH_ALEN];
#endif
...
#define P2P_SEC_DEVICE_TYPES 5
	...
	/**
	 * channel_rank - get the channel ranking
	 * @ctx: Callback context from cb_ctx
	 * @buf: buffer to bt returned containing channel index information
	 * @buf_len: length ot the buffer given in the buf parameter
	 * Returns: Length of the output buffer
	 */
	int (*channel_rank)(void *ctx, u8 *buf, int buf_len);
#endif
