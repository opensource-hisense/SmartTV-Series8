...
#if defined(CONFIG_INTEGRATOR) || defined(CONFIG_ARCH_MT5391) || defined(CONFIG_ARCH_MT5881) || \
    defined(CONFIG_ARCH_MT5395) || defined(CONFIG_ARCH_MT5365) || defined(CONFIG_ARCH_MT5389)
