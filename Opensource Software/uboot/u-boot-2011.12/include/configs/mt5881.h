/*
 * u-boot-2011.12/include/configs/mt5880.h
 *
...
#define CONFIG_ARCH_MT5881 1
#define CONFIG_CM1176JZ_S 1 /* CPU core is ARM1176JZ-S */
#define CONFIG_CMCA9 0 /* CPU core is CA9 */
...
#define CONFIG_SYS_PHY_UBOOT_BASE (0x01000000)
...
#define CONFIG_BOOTDELAY    0
    ...
    #define CONFIG_BOOTARGS_BASE2   "root=/dev/mmcblk0p8 rootwait rootfstype=squashfs ro console=ttyMT0,115200n1 vmalloc=512mb"
	    ...
	    #define CONFIG_BOOTARGS_BASE_ANDROID  "lpj=4571136 console=ttyMT0,115200n1 root=/dev/mmcblk0p5 vmalloc=512mb"
    #else
...
#define CFG_PROMPT  "mt5881 # " /* Monitor Command Prompt   */
