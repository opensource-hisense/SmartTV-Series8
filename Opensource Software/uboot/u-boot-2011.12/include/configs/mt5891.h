...
#endif
//#define USING_EMMC_STORAGE_BOOTFLAG
...
#define CONFIG_ENV_A_OFFSET   CFG_ENV_A_OFFSET
#define CONFIG_ENV_B_OFFSET   CFG_ENV_B_OFFSET
...
//#if defined(CC_SUPPORT_4K2K)
	    ...
	    #define CONFIG_BOOTARGS_BASE2   "root=/dev/mmcblk0p13 rootwait rootfstype=squashfs ro console=ttyMT0,115200n1 vmalloc=512mb"
			...
			#define CONFIG_BOOTARGS_BASE    "root=/dev/mmcblk0p7 rootwait rootfstype=squashfs ro console=ttyMT0,115200n1 vmalloc=875mb"
		    #define CONFIG_BOOTARGS_BASE2   "root=/dev/mmcblk0p8 rootwait rootfstype=squashfs ro console=ttyMT0,115200n1 vmalloc=875mb"
		#else
		    #if defined(HIS_LASERTV_UART1)||defined(HIS_TWTV_UART1)
		    #define CONFIG_BOOTARGS_BASE    "root=/dev/mmcblk0p7 rootwait rootfstype=squashfs ro console=ttyMT1,115200n1 vmalloc=512mb"
		    #define CONFIG_BOOTARGS_BASE2   "root=/dev/mmcblk0p8 rootwait rootfstype=squashfs ro console=ttyMT1,115200n1 vmalloc=512mb"
			#else
...
#define CFG_PROMPT  "mt5891 # " /* Monitor Command Prompt   */
...
#define PHYS_SDRAM_1_FHD_SIZE (TOTAL_MEM_SIZE - FBM_MEM_CFG_MT5890_3DTV_FHD - DIRECT_FB_MEM_SIZE - FB_MEM_SIZE)
#endif
...
#define PHYS_SDRAM_2_FHD_SIZE (DEFAULT_CHANNEL_B_SIZE - FBM_MEM_CFG_MT5890_3DTV_FHD_CHB-  TRUSTZONE_MEM_SIZE)
#endif
#else
...
#define PHYS_SDRAM_2_FHD_SIZE (TOTAL_MEM_SIZE - FBM_MEM_CFG_MT5890_3DTV_FHD_CHB-  TRUSTZONE_MEM_SIZE)
#endif
#endif
#endif
#if defined(CC_SUPPORT_CHANNEL_C)
#undef CONFIG_NR_DRAM_BANKS
#define CONFIG_NR_DRAM_BANKS    3   /* we have 3 bank of DRAM */
#define	PHYS_SDRAM_3 (TOTAL_MEM_SIZE + TOTAL_CHB_MEM_SIZE + FBM_MEM_CHC_CFG_SIZE)
#define	PHYS_SDRAM_3_SIZE (TOTAL_CHC_MEM_SIZE - FBM_MEM_CHC_CFG_SIZE)
#endif
 ...
 */
    ...
    #ifndef CFG_ENV_A_OFFSET
        #ifdef NAND_PART_OFFSET_2
            #define CFG_ENV_A_OFFSET      NAND_PART_OFFSET_2
        #else
            #define CFG_ENV_A_OFFSET      0x400000     // offset: 4MB
        #endif
    #endif

    #ifndef CFG_ENV_B_OFFSET
        #ifdef NAND_PART_OFFSET_3
            #define CFG_ENV_B_OFFSET      NAND_PART_OFFSET_3    // 128KB
        #else
            #define CFG_ENV_B_OFFSET      0x600000    // offset: 6MB
        #endif
    #endif
    #ifndef CFG_ENV_SIZE
