...
make clean ARCH=arm BUILD=debug  PLATFORM_VERSION=4.2 SGXCORE=543 SGXCOREREV=303 SGX_FEATURE_MP=1 SGX_FEATURE_MP_CORE_COUNT=2 CROSS_COMPILE=$OPT_CROSS_COMPILE KERNEL_CROSS_COMPILE=$OPT_CROSS_COMPILE TARGET_DEVICE=mt5399
