                                        ...
                                        mng_imagedatap *ppObject)
{
  ...
  memset(pImagedata, 0, sizeof(mng_imagedata));
  ...
  if (pData->bHasglobalICCP)           /* glbal iCCP present ? */
  {
    ...
    if (pImagedata->iProfilesize)
    {
      ...
      {
		  if (pImagedata->iImgdatasize != 0 && pImagedata->pImgdata != NULL)
                                    ...
                                    mng_imagep *ppObject)
{
  ...
  memset(pImage, 0, sizeof (mng_image));
                                      ...
                                      mng_bool   bResetall)
{
  ...
  {                                    /* drop the old one */
	if (pBuf->pImgdata != NULL && pBuf->iImgdatasize != 0)
	{
    ...
    if (iImgdatasize)                  /* allocate new sample-buffer ? */
	{
	  ...
	  memset(pBuf->pImgdata, 0, iImgdatasize);
	}
  }
  else
  {
