...
int __init hidraw_init(void)
{
 ...
 //    result = alloc_chrdev_region(&dev_id, HIDRAW_FIRST_MINOR, IDRAW_MAX_DEVICES, "hidraw");
 //    result = alloc_chrdev_region(&dev_id, 0, 2, "hidraw");   
 //    hidraw_major = MAJOR(dev_id);
    dev_id = MKDEV(hidraw_major,0);
    register_chrdev_region(dev_id, 8, "hidraw");
