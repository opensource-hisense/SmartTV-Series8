...
{                                           \
  SFLASH_WRITE32(0xFD008718, 0x0);          \
  SFLASH_WRITE32(0xFD008718, 0x2);          \
  SFLASH_WRITE32(0xFD008718, 0x0);          \
}
...
{                                                         \
  SFLASH_WRITE32(0xFD00871C, src);                        \
  SFLASH_WRITE32(0xFD008720, deststart);                  \
  SFLASH_WRITE32(0xFD008724, deststart+len);              \ 
}

// DMA Trigger
#define SFLASH_DMA_START                    \
{											\
  SFLASH_WRITE32(0xFD008718, 0x05);			\
}
