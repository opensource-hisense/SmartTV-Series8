...
public:
    ...
    // Public for HTMLParamElement::attributeChanged()
    void sendUpdatedParametersToPlugin();
...
protected:
    ...
    bool pluginCanExistWithoutLayoutObject() const;
    ...
    virtual void parametersForPlugin(Vector<String>& paramNames, Vector<String>& paramValues, String& url, String& serviceType);
...
private:
    ...
    // Used to secure against recursive call of createPlugin
    bool m_isInPluginCreation;
};
