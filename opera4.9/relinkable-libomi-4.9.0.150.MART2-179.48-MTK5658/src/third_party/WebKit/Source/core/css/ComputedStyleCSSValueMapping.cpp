...
static CSSValue* valueForNavigationDirection(const ComputedStyle& style, CSSPropertyID propertyID)
{
    ...
    CSSValueList* list = CSSValueList::createSpaceSeparated();
    list->append(*CSSIdSelValue::create(navValue.id()));
    list->append(*CSSStringValue::create(navValue.target()));
