...
public:
    ...
    InputFormatType inputFormat() const { return static_cast<InputFormatType>(rareNonInheritedData->m_inputFormat); }
    // End CSS3 Getters
...
// attribute setter methods
    ...
    void setInputFormat(InputFormatType type) { SET_VAR(rareNonInheritedData, m_inputFormat, type); }
    // End CSS3 Setters
    ...
    static InputFormatType initialInputFormat() { return InputFormatNone; }
