...
StyleRareNonInheritedData::StyleRareNonInheritedData()
    ...
    , m_inputFormat(ComputedStyle::initialInputFormat())
...
StyleRareNonInheritedData::StyleRareNonInheritedData(const StyleRareNonInheritedData& o)
    ...
    , m_navigation(o.m_navigation ? wrapUnique(new StyleNavigationData(*o.m_navigation)) : nullptr)
...
{
    if (!m_navigation)
        m_navigation = wrapUnique(new StyleNavigationData());
