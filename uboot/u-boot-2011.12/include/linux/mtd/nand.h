...
struct nand_chip {
    ...
    int     (*read_page)(struct mtd_info *mtd, u_char *data_buf, u_char *oob_buf);

#if NAND_ASYNC_READ_ENABLE
    int     (*async_read_start)(struct mtd_info *mtd);
    int     (*async_read_finish)(struct mtd_info *mtd, int len, u_char *data_buf);
#endif
