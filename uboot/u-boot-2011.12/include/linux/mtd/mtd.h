...
#define NAND_ASYNC_READ_ENABLE 1
...
struct mtd_info {
	...
	int (*async_read_start) (struct mtd_info *mtd, loff_t from, size_t len, u_char *buf);
    int (*async_read_wait_finish) (struct mtd_info *mtd, loff_t from, size_t len, u_char *buf);
#endif
