...
#ifdef CC_USB3_ADB_ENABLE
#define CONFIG_BOOT_ARGS_U3_ADB_EN " ssusb_adb=1"
#else
#define CONFIG_BOOT_ARGS_U3_ADB_EN " "
#endif

#if CONFIG_ANDROID
		#if defined(CC_DEBUG)
				#define CONFIG_BOOTARGS         CONFIG_BOOTARGS_BASE_ANDROID" debug" CONFIG_BOOT_ARGS_U3_ADB_EN
		#else
    #ifndef CC_UBOOT_QUIET_BOOT
        #define CONFIG_BOOTARGS         CONFIG_BOOTARGS_BASE_ANDROID CONFIG_BOOT_ARGS_U3_ADB_EN
    #else
        #define CONFIG_BOOTARGS         CONFIG_BOOTARGS_BASE_ANDROID" quiet" CONFIG_BOOT_ARGS_U3_ADB_EN
    #endif
    #endif
#else
...
#define PHYS_SDRAM_1_4K_SIZE  (TOTAL_MEM_SIZE - FBM_MEM_CFG_MT5890_3DTV_4K - DIRECT_FB_MEM_SIZE - FB_MEM_SIZE)
#ifdef FB_MEM_SIZE_FHD_MODEL
#define PHYS_SDRAM_1_FHD_SIZE (TOTAL_MEM_SIZE - FBM_MEM_CFG_MT5890_3DTV_2K80 - DIRECT_FB_MEM_SIZE - FB_MEM_SIZE_FHD_MODEL)
#else
#define PHYS_SDRAM_1_FHD_SIZE (TOTAL_MEM_SIZE - FBM_MEM_CFG_MT5890_3DTV_2K80 - DIRECT_FB_MEM_SIZE - FB_MEM_SIZE)
#endif
#endif
...
#if defined(CC_DYNAMIC_FBMSRM_CONF)
#define PHYS_SDRAM_2_4K_SIZE  (DEFAULT_CHANNEL_B_SIZE - FBM_MEM_CFG_MT5890_3DTV_4K_CHB-  TRUSTZONE_MEM_SIZE)
#define PHYS_SDRAM_2_FHD_SIZE (DEFAULT_CHANNEL_B_SIZE - FBM_MEM_CFG_MT5890_3DTV_2K80_CHB-  TRUSTZONE_MEM_SIZE)
#endif
#else
...
#if defined(CC_DYNAMIC_FBMSRM_CONF)
#define PHYS_SDRAM_2_4K_SIZE  (TOTAL_MEM_SIZE - FBM_MEM_CFG_MT5890_3DTV_4K_CHB-  TRUSTZONE_MEM_SIZE)
#define PHYS_SDRAM_2_FHD_SIZE (TOTAL_MEM_SIZE - FBM_MEM_CFG_MT5890_3DTV_2K80_CHB-  TRUSTZONE_MEM_SIZE)
#endif
#endif
#endif
#else  //CC_TRUSTZONE_IN_CHB
#if defined(CC_DYNAMIC_FBMSRM_CONF)
#define PHYS_SDRAM_1_4K_SIZE  (TOTAL_MEM_SIZE - FBM_MEM_CFG_MT5890_3DTV_4K - DIRECT_FB_MEM_SIZE - FB_MEM_SIZE - TRUSTZONE_MEM_SIZE)
#ifdef FB_MEM_SIZE_FHD_MODEL
#define PHYS_SDRAM_1_FHD_SIZE (TOTAL_MEM_SIZE - FBM_MEM_CFG_MT5890_3DTV_FHD - DIRECT_FB_MEM_SIZE - FB_MEM_SIZE_FHD_MODEL - TRUSTZONE_MEM_SIZE)
#else
#define PHYS_SDRAM_1_FHD_SIZE (TOTAL_MEM_SIZE - FBM_MEM_CFG_MT5890_3DTV_FHD - DIRECT_FB_MEM_SIZE - FB_MEM_SIZE - TRUSTZONE_MEM_SIZE)
#endif
#endif
#if CONFIG_NR_DRAM_BANKS>1
#ifdef CC_SUPPORT_MULTI_DRAM_COMBINATION//if CC_SUPPORT_MULTI_DRAM_COMBINATION is defined, these 2 define may be overwrote in u-boot-1.3.4/lib_arm/board.c::get_kernel_size() 
#define PHYS_SDRAM_2        (DEFAULT_CHANNEL_A_SIZE + FBM_MEM_CHB_CFG_SIZE) /* SDRAM Bank #2 */
#define PHYS_SDRAM_2_SIZE   (DEFAULT_CHANNEL_B_SIZE - FBM_MEM_CHB_CFG_SIZE)//((IS_DRAM_SIZE_MORE_THAN_1G) ? (TOTAL_MEM_SIZE/4-0x7800000) : (TOTAL_MEM_SIZE-0x7800000)) 
#if defined(CC_DYNAMIC_FBMSRM_CONF)
#define PHYS_SDRAM_2_4K_SIZE  (DEFAULT_CHANNEL_B_SIZE - FBM_MEM_CFG_MT5890_3DTV_4K_CHB )
#define PHYS_SDRAM_2_FHD_SIZE (DEFAULT_CHANNEL_B_SIZE - FBM_MEM_CFG_MT5890_3DTV_FHD_CHB )
#endif
#else
#define PHYS_SDRAM_2        (TOTAL_MEM_SIZE + FBM_MEM_CHB_CFG_SIZE)  /* SDRAM Bank #2 */
#define PHYS_SDRAM_2_SIZE   (TOTAL_MEM_SIZE - FBM_MEM_CHB_CFG_SIZE)
#if defined(CC_DYNAMIC_FBMSRM_CONF)
#define PHYS_SDRAM_2_4K_SIZE  (TOTAL_MEM_SIZE - FBM_MEM_CFG_MT5890_3DTV_4K_CHB)
#define PHYS_SDRAM_2_FHD_SIZE (TOTAL_MEM_SIZE - FBM_MEM_CFG_MT5890_3DTV_FHD_CHB)
#endif
#endif
#endif
#endif //CC_TRUSTZONE_IN_CHB
...
#if defined(CC_DYNAMIC_FBMSRM_CONF)
#define GPU_MEM_4K_TOTAL_SIZE (0)
#define GPU_MEM_FHD_TOTAL_SIZE (0)

#define GPU_ION_4K_USING_SIZE (0)
#define GPU_ION_FHD_USING_SIZE (0)
#endif

#endif

#if defined(CC_DYNAMIC_FBMSRM_CONF)
#define PHYS_GPU_4K_START   ((PHYS_SDRAM_1_4K_SIZE > GPU_MEM_TOTAL_SIZE)? (PHYS_SDRAM_1_4K_SIZE - GPU_MEM_TOTAL_SIZE):0)
#define PHYS_GPU_FHD_START   ((PHYS_SDRAM_1_FHD_SIZE > GPU_MEM_TOTAL_SIZE)? (PHYS_SDRAM_1_FHD_SIZE - GPU_MEM_TOTAL_SIZE):0)
#endif
...
#if defined(CC_DYNAMIC_FBMSRM_CONF)
#define PHYS_GPU_4K_SIZE   (GPU_MEM_4K_TOTAL_SIZE)
#define PHYS_GPU_FHD_SIZE   (GPU_MEM_FHD_TOTAL_SIZE)
#define PHYS_GPU_4K_ION_SIZE   (GPU_ION_4K_USING_SIZE)
#define PHYS_GPU_FHD_ION_SIZE   (GPU_ION_4K_USING_SIZE)
#endif
