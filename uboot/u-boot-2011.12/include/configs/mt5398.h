...
#define LPJ_IC_VER1      0x53980001         // 5398 AB
#define LPJ_IC_VALUE1     "lpj=4579382"
#define LPJ_IC_VER2      0x53980002         // 5398 AC
#define LPJ_IC_VALUE2     "lpj=4780032"
//#include "../../../drv_lib/drv_inc/c_model.h"
//#include "../../../../../output/mtk_linux/mt5398_atsc_linux/debug/inc/drv_inc/c_model.h"

#define CONFIG_ARCH_MT5398 1
...
#if defined(CC_EMMC_BOOT)
    #define CONFIG_BOOTARGS_BASE    "root=/dev/mmcblk0p7 rootwait rootfstype=squashfs ro console=ttyMT0,115200n1 vmalloc=515mb"
    #define CONFIG_BOOTARGS_BASE2   "root=/dev/mmcblk0p8 rootwait rootfstype=squashfs ro console=ttyMT0,115200n1 vmalloc=515mb"
    #if CONFIG_ANDROID_BOOT
	    #define CONFIG_BOOTARGS_BASE_ANDROID  "lpj=4571136 console=ttyMT0,115200n1 root=/dev/mmcblk0p5 vmalloc=515mb"
    #else
        #define CONFIG_BOOTARGS_BASE_ANDROID  "lpj=4571136 console=ttyMT0,115200n1 ubi.mtd=6 root=ubi0:rootfs" \
                                              " rootfstype=ubifs init=/init vmalloc=515mb"
    #endif //CONFIG_ANDROID_BOOT
    
#elif !defined(CC_KERNEL_ON_NOR)
    #define CONFIG_BOOTARGS_BASE    "root=/dev/mtdblock6 rootwait rootfstype=squashfs ro console=ttyMT0,115200n1 vmalloc=515mb"
    #define CONFIG_BOOTARGS_BASE2   "root=/dev/mtdblock7 rootwait rootfstype=squashfs ro console=ttyMT0,115200n1 vmalloc=515mb"
    #if CONFIG_ANDROID_BOOT
        #define CONFIG_BOOTARGS_BASE_ANDROID  "console=ttyMT0,115200n1 root=/dev/ram vmalloc=515mb"
    #else
    #define CONFIG_BOOTARGS_BASE_ANDROID  "console=ttyMT0,115200n1 ubi.mtd=6 root=ubi0:rootfs" \
                                              " rootfstype=ubifs init=/init vmalloc=515mb"
    #endif //CONFIG_ANDROID_BOOT
#else
    #define CONFIG_BOOTARGS_BASE    "root=/dev/ram console=ttyMT0,115200n1 vmalloc=515mb"
#endif
...
#define CFG_PROMPT  "mt5398 # " /* Monitor Command Prompt   */
...
//#include "../../../../../output/mtk_linux/mt5398_atsc_linux/debug/inc/drv_inc/c_model.h"
//#include "../../../drv_lib/mt5398/drv_cust/drv_default.h"
#include "c_model.h"
...
#define PHYS_SDRAM_2_SIZE   LINUX_CHB_KERNEL_MEM_SIZE /*you can define this MACRO in your drv_cust*/
#endif
