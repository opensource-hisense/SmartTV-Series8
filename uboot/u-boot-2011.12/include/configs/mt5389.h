/*
 * u-boot-2011.12/include/configs/mt5389.h
 *
...
#if defined(CC_EMMC_BOOT)
    #define CONFIG_BOOTARGS_BASE    "root=/dev/mmcblk0p7 rootwait lpj=1814528 console=ttyMT0,115200n1"
    #define CONFIG_BOOTARGS_BASE2   "root=/dev/mmcblk0p8 rootwait lpj=1814528 console=ttyMT0,115200n1"
#elif !defined(CC_KERNEL_ON_NOR)
    #define CONFIG_BOOTARGS_BASE    "root=/dev/mtdblock6 rootwait lpj=1814528 console=ttyMT0,115200n1"
    #define CONFIG_BOOTARGS_BASE2   "root=/dev/mtdblock7 rootwait lpj=1814528 console=ttyMT0,115200n1"
#else
    #define CONFIG_BOOTARGS_BASE    "root=/dev/ram lpj=1814528 console=ttyMT0,115200n1"
#endif
...
#define CFG_PROMPT  "mt5389 # " /* Monitor Command Prompt   */
...
#if defined(CC_EMMC_BOOT)
    #define BOOTCMD_ENV \
        "bootcmd=eboot kernelA rootfsA\0"
#elif !defined(CC_KERNEL_ON_NOR)
    #define BOOTCMD_ENV \
