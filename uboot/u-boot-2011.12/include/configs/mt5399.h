...
#define CONFIG_BOOTDELAY    0
...
#if defined(CC_SUPPORT_TV_STAGEFRIGHT_4K2K)
#if defined(CC_EMMC_BOOT)
    #define CONFIG_BOOTARGS_BASE    "root=/dev/mmcblk0p7 rootwait rootfstype=squashfs ro console=ttyMT0,115200n1 vmalloc=595mb"
    #define CONFIG_BOOTARGS_BASE2   "root=/dev/mmcblk0p8 rootwait rootfstype=squashfs ro console=ttyMT0,115200n1 vmalloc=595mb"
    #if CONFIG_ANDROID_BOOT
	    #define CONFIG_BOOTARGS_BASE_ANDROID  "lpj=4780032 console=ttyMT0,115200n1 root=/dev/mmcblk0p5 vmalloc=595mb"
    #else
        #define CONFIG_BOOTARGS_BASE_ANDROID  "lpj=4780032 console=ttyMT0,115200n1 ubi.mtd=6 root=ubi0:rootfs" \
                                              " rootfstype=ubifs init=/init vmalloc=595mb"
    #endif //CONFIG_ANDROID_BOOT
    
#elif !defined(CC_KERNEL_ON_NOR)
    #define CONFIG_BOOTARGS_BASE    "root=/dev/mtdblock6 rootwait rootfstype=squashfs ro console=ttyMT0,115200n1 vmalloc=595mb"
    #define CONFIG_BOOTARGS_BASE2   "root=/dev/mtdblock7 rootwait rootfstype=squashfs ro console=ttyMT0,115200n1 vmalloc=595mb"
    #if CONFIG_ANDROID_BOOT
        #define CONFIG_BOOTARGS_BASE_ANDROID  "console=ttyMT0,115200n1 root=/dev/ram vmalloc=595mb"
    #else
    #define CONFIG_BOOTARGS_BASE_ANDROID  "console=ttyMT0,115200n1 ubi.mtd=6 root=ubi0:rootfs" \
                                              " rootfstype=ubifs init=/init vmalloc=595mb"
    #endif //CONFIG_ANDROID_BOOT
#else
    #define CONFIG_BOOTARGS_BASE    "root=/dev/ram console=ttyMT0,115200n1 vmalloc=595mb"
#endif
#else
#if defined(CC_EMMC_BOOT)
    #if defined(CC_TWO_WORLD_RFS)
    #define CONFIG_BOOTARGS_BASE    "root=/dev/mmcblk0p13 rootwait rootfstype=squashfs ro console=ttyMT0,115200n1 vmalloc=590mb"
    #define CONFIG_BOOTARGS_BASE2   "root=/dev/mmcblk0p13 rootwait rootfstype=squashfs ro console=ttyMT0,115200n1 vmalloc=590mb"	
	#else
    #define CONFIG_BOOTARGS_BASE    "root=/dev/mmcblk0p7 rootwait rootfstype=squashfs ro console=ttyMT0,115200n1 vmalloc=590mb"
    #define CONFIG_BOOTARGS_BASE2   "root=/dev/mmcblk0p8 rootwait rootfstype=squashfs ro console=ttyMT0,115200n1 vmalloc=590mb"
    #endif
    #if CONFIG_ANDROID_BOOT
	#if ((defined (CC_FORCE_DRAM1G)) || (defined (CC_FORCE_DRAM768M)))
	    #define CONFIG_BOOTARGS_BASE_ANDROID  "lpj=4780032 console=ttyMT0,115200n1 root=/dev/mmcblk0p5 vmalloc=590mb"
	#else
	    #define CONFIG_BOOTARGS_BASE_ANDROID  "lpj=4780032 console=ttyMT0,115200n1 root=/dev/mmcblk0p5 vmalloc=768mb"
	#endif
    #else
        #define CONFIG_BOOTARGS_BASE_ANDROID  "lpj=4780032 console=ttyMT0,115200n1 ubi.mtd=6 root=ubi0:rootfs" \
                                              " rootfstype=ubifs init=/init vmalloc=590mb"
    #endif //CONFIG_ANDROID_BOOT
    
#elif !defined(CC_KERNEL_ON_NOR)
    #define CONFIG_BOOTARGS_BASE    "root=/dev/mtdblock6 rootwait rootfstype=squashfs ro console=ttyMT0,115200n1 vmalloc=590mb"
    #define CONFIG_BOOTARGS_BASE2   "root=/dev/mtdblock7 rootwait rootfstype=squashfs ro console=ttyMT0,115200n1 vmalloc=590mb"
    #if CONFIG_ANDROID_BOOT
        #define CONFIG_BOOTARGS_BASE_ANDROID  "console=ttyMT0,115200n1 root=/dev/ram vmalloc=590mb"
    #else
    #define CONFIG_BOOTARGS_BASE_ANDROID  "console=ttyMT0,115200n1 ubi.mtd=6 root=ubi0:rootfs" \
                                              " rootfstype=ubifs init=/init vmalloc=590mb"
    #endif //CONFIG_ANDROID_BOOT
#else
    #define CONFIG_BOOTARGS_BASE    "root=/dev/ram console=ttyMT0,115200n1 vmalloc=590mb"
#endif
#endif
...
#if defined(CC_EMMC_BOOT)
    #if defined(CC_TWO_WORLD_RFS)
    #define CONFIG_BOOTARGS_BASE	"root=/dev/mmcblk0p13 rootwait rootfstype=squashfs ro console=ttyMT0,115200n1 vmalloc=578mb"
    #define CONFIG_BOOTARGS_BASE2	"root=/dev/mmcblk0p13 rootwait rootfstype=squashfs ro console=ttyMT0,115200n1 vmalloc=578mb"
	#else
    #define CONFIG_BOOTARGS_BASE    "root=/dev/mmcblk0p7 rootwait rootfstype=squashfs ro console=ttyMT0,115200n1 vmalloc=578mb"
    #define CONFIG_BOOTARGS_BASE2   "root=/dev/mmcblk0p8 rootwait rootfstype=squashfs ro console=ttyMT0,115200n1 vmalloc=578mb"
	#endif
    #if CONFIG_ANDROID_BOOT
	    #define CONFIG_BOOTARGS_BASE_ANDROID  "lpj=4780032 console=ttyMT0,115200n1 root=/dev/mmcblk0p5 vmalloc=610mb"
    #else
        #define CONFIG_BOOTARGS_BASE_ANDROID  "lpj=4780032 console=ttyMT0,115200n1 ubi.mtd=6 root=ubi0:rootfs" \
                                              " rootfstype=ubifs init=/init vmalloc=578mb"
    #endif //CONFIG_ANDROID_BOOT
    
#elif !defined(CC_KERNEL_ON_NOR)
    #define CONFIG_BOOTARGS_BASE    "root=/dev/mtdblock6 rootwait rootfstype=squashfs ro console=ttyMT0,115200n1 vmalloc=578mb"
    #define CONFIG_BOOTARGS_BASE2   "root=/dev/mtdblock7 rootwait rootfstype=squashfs ro console=ttyMT0,115200n1 vmalloc=578mb"
    #if CONFIG_ANDROID_BOOT
        #define CONFIG_BOOTARGS_BASE_ANDROID  "console=ttyMT0,115200n1 root=/dev/ram vmalloc=578mb"
    #else
    #define CONFIG_BOOTARGS_BASE_ANDROID  "console=ttyMT0,115200n1 ubi.mtd=6 root=ubi0:rootfs" \
                                              " rootfstype=ubifs init=/init vmalloc=578mb"
    #endif //CONFIG_ANDROID_BOOT
#else
    #define CONFIG_BOOTARGS_BASE    "root=/dev/ram console=ttyMT0,115200n1 vmalloc=578mb"
#endif


#else	// ! CC_SUPPORT_4K2K !CC_FBM_FOUR_INST_SUPPORT
#if defined(CC_EMMC_BOOT)
    #if defined(CC_TWO_WORLD_RFS)
	...
	#endif
    #if CONFIG_ANDROID_BOOT
	    #define CONFIG_BOOTARGS_BASE_ANDROID  "lpj=4780032 console=ttyMT0,115200n1 root=/dev/mmcblk0p5 vmalloc=544mb"
    #else
        #define CONFIG_BOOTARGS_BASE_ANDROID  "lpj=4780032 console=ttyMT0,115200n1 ubi.mtd=6 root=ubi0:rootfs" \
...
#define CFG_PROMPT  "mt5399 # " /* Monitor Command Prompt   */
...
#define PHYS_SDRAM_2_SIZE   (DEFAULT_CHANNEL_B_SIZE-FBM_MJC_RSV_POOL_SIZE)//((IS_DRAM_SIZE_MORE_THAN_1G) ? (TOTAL_MEM_SIZE/4-0x7800000) : (TOTAL_MEM_SIZE-0x7800000)) 
#else
#ifdef CC_TVP_SUPPORT
#define PHYS_SDRAM_2        TOTAL_MEM_SIZE +FBM_MJC_RSV_POOL_SIZE /* SDRAM Bank #2 */
#else
#define PHYS_SDRAM_2        TOTAL_MEM_SIZE  /* SDRAM Bank #2 */
#endif
#define PHYS_SDRAM_2_SIZE   (TOTAL_MEM_SIZE-FBM_MJC_RSV_POOL_SIZE)
#endif
#endif
