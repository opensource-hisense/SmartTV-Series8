...
ifdef CONFIG_ANDROID #Carter Added for Android
L_CFLAGS += -DANDROID
endif

ifdef CONFIG_HE_SUPPORT #Added for HE/DTV special event support
L_CFLAGS += -DCONFIG_HE_SUPPORT
endif

ifdef CONFIG_HE_BD #Added for HE/DTV _ BD special event support
L_CFLAGS += -DCONFIG_HE_BD
endif
ifdef CONFIG_IPV6
# for eapol_test only
