...
/** Mac selected */
#define WPA_EVENT_MAC_SELECTED "CTRL-EVENT-MAC-SELECTED "
#endif
...
/*TDLS events*/
#define TDLS_EVENT_SCAN_STARTED "TDLS-SCAN-STARTED "
#define TDLS_EVENT_SCAN_COMPLETED "TDLS-SCAN-COMPLETED "
#define TDLS_EVENT_SCAN_FAILED "TDLS-SCAN-FAILED "
#define TDLS_EVENT_DEVICE_FOUND "TDLS-DEVICE-FOUND "
#define TDLS_EVENT_PEER_CONNECTED "TDLS-PEER-CONNECTED " /*+ peer MAC*/
#define TDLS_EVENT_PEER_WFD_INFO "TDLS-PEER-WFD-INFO " /*+ wfd_dev_info_hex(reference to WFD Device Information)*/
#define TDLS_EVENT_PEER_TEARDOWN "TDLS-PEER-TEARDOWN " /*+ peer MAC*/
