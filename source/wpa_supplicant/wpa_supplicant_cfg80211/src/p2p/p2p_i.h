...
struct p2p_device {
	...
	u8 go_intent;
	int go_intent_recored;
	int peer_connect_recorded;
...
struct p2p_data {
	...
	u8 go_intent;
	/**
	 * p2p_oper_freq - set opchannel
	 */
#ifdef CONFIG_SUPPORT_SET_OP_FREQ
	unsigned int p2p_oper_freq;
#endif
	...
	//Add for get current gourp capability
	u8 group_capab;
#endif
	...
	enum p2p_pending_action_type {
		P2P_PENDING_ACTION_NONE,
		P2P_PENDING_ACTION_PUBLIC,
		P2P_PENDING_ACTION_VENDOR_SPECIFIC,
	} pending_action_type;
#endif
