...
{
	/* We should not write config file on the mtk platform
	 * The ahthentication infomation is recored by mw and stored in eeporm
	 * The wps process should the process return success
	 * Therefore the function only return success
	 */
	return 0; 
}
#else
