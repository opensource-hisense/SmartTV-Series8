...
L_CFLAGS += -DCONFIG_MTK_HE_SUPPORT
endif
...
ifeq ($(CONFIG_P2P_OPERATION_CH_FOLLOW_AP), y)
L_CFLAGS += -DCONFIG_P2P_OPERATION_CH_FOLLOW_AP
endif
...
LOCAL_LDFLAGS += $(TOP)/device/mediatek_common/vm_linux/android/mediatek/device/prebuilt/$(BOARD_WPA_SUPPLICANT_PRIVATE_LIB).a
endif
endif
LOCAL_SHARED_LIBRARIES := libc libcutils liblog
ifdef CONFIG_EAP_PROXY
