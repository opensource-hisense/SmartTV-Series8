...
static int p2p_intersection_5g_num(struct p2p_channels *intersection, int p2p_5g_channel[2][160], int p2p_24g_channel[2][14])
{
			  ...
			  struct p2p_channels *intersection)
{
    ...
    numb_5g = p2p_intersection_5g_num(intersection, p2p_5g_channel, p2p_24g_channel);
